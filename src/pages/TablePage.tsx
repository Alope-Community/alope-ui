...
export default function TablePage() {
  ...
  return (
    <Container
      ...
      description="A flexible and reusable table component with support for selection, sticky headers, custom rendering, and more."
    >
      {/* Size */}
      <section>
      ...
      <section>
        ...
        <Table size="sm" striped columns={columns} data={data} />
      </section>
