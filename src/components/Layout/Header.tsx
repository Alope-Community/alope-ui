...
export default function Hero() {
  ...
  return (
    <div className="relative bg-white dark:bg-gray-900 transition-colors duration-500 pt-10">
      <div
      ...
      <div className="relative z-10 container mx-auto">
        <section>
          <div className="px-4 py-28 gap-12 text-gray-600 overflow-hidden md:flex">
            <div className="flex-none space-y-5">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white leading-tight mb-6 max-w-3xl">
                Alope UI for <br /> Less styling{","}
                <span className="text-green-700 px-2 rounded-sm  dark:text-green-500 leading-none py-[0.5px]">
                  More building
                </span>
              </h1>
