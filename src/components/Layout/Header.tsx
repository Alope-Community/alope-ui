...
export default function Hero() {
  ...
  useEffect(() => {
    document.onclick = (e) => {
      // bisa untuk close dropdown atau modal kalau ada nanti
    }
    return () => {
        ...
        <section>
          <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 overflow-hidden md:px-20 md:flex">
            <div className="flex-none space-y-5 max-w-xl">
              <a
                href="#"
                className="inline-flex gap-x-6 items-center rounded-lg p-1 pr-6 border text-sm font-medium duration-150 hover:bg-green-100"
              >
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white leading-tight mb-6 max-w-3xl">
                ...
                <span className="inline-block  text-green-700 px-2 rounded-sm  dark:text-white leading-none py-[0.5px]">
                  with ease
                </span>
              </h1>
