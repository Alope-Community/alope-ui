...
import { AccordionPage, AlertPage, AvatarPage, BadgePage, BottomNavbarPage, BreadcrumbPage, ButtonPage, CardPage, CheckboxInputPage, CollectionPage, FABPage, FileUploadPage, GridPage, MasonryPage, ModalPage, OffcanvasPage, PaginationPage, PopoverPage, RadioInputPage, SelectInputPage, SkeletonPage, SpinnerPage, TablePage, TabsPage, TextareaPage, TextInputPage, TimelinePage, ToastPage, TogglePage, TooltipPage, } from './pages'
