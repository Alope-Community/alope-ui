...
const BadgeVariants = {
    default: 'bg-primary-30 text-primary-700',
    secondary: 'bg-secondary-30 text-black',
    success: 'bg-success-30 text-green-700',
    error: 'bg-error-30 text-red-700',
    info: 'bg-info-30 text-blue-700',
    warning: 'bg-warning-30 text-amber-700'
}
